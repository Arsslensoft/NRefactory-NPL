lexer grammar RSharpLexer;

@lexer::header { using System.Collections.Generic; }

@lexer::channels { COMMENTS_CHANNEL, DIRECTIVE }
...
OCT_INTEGER_LITERAL: '0' [oO] OctDigit+ IntegerTypeSuffix?;
BIN_INTEGER_LITERAL: '0' [bB] BinDigit+ IntegerTypeSuffix?;

BINARY_OPERATOR_LITERAL: '@@' OpSymbol+;
UNARY_OPERATOR_LITERAL: '@' OpSymbol+;
...
OP_LEFT_ROTATE_ASSIGNMENT:'<~=';
OP_RIGHT_SHIFT:            '>>';
OP_RIGHT_ROTATE:           '~>';
OP_RIGHT_SHIFT_ASSIGNMENT: '>>=';
OP_RIGHT_ROTATE_ASSIGNMENT:'~>=';
OP_PARITY:                 '?~';
OP_ZERO:                    '?!';
RIGHT_ARROW: '=>';
